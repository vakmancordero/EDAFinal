...
Node *BinaryTreeAVL::add(Node *node, Person value) {
...
Node *BinaryTreeAVL::remove(Node *root, Person value) {
...
void BinaryTreeAVL::add(Person value) {
...
void BinaryTreeAVL::remove(Person value) {
...
void BinaryTreeAVL::preOrder(Node *root) {
    if (root != nullptr) {
        cout << root->getValue().toString().toStdString() << "\n";
...
void BinaryTreeAVL::inOrder(Node *root) {
    if (root != nullptr) {
        ...
        qDebug() << root->getValue().toString() << endl;
...
Node* BinaryTreeAVL::find(Person value, Node* node) {
...
Node* BinaryTreeAVL::find(Person value){
